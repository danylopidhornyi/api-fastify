...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: "user" | "product" | "transaction";
   ...
   * ProductCountOutputType without action
   */
  export type ProductCountOutputTypeCountTransactionsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: TransactionWhereInput;
  };
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise";
    transactions<T extends Product$transactionsArgs<ExtArgs> = {}>(
      args?: Subset<T, Product$transactionsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TransactionPayload<ExtArgs>,
          T,
   ...
   */
  export type Product$transactionsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Transaction
  ...
  export type TransactionOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    "id" | "userId" | "productId" | "amount" | "createdAt",
    ExtArgs["result"]["transaction"]
  >;
  ...
  export type TransactionCreateNestedManyWithoutProductInput = {
    create?:
      | XOR<
          ...
          TransactionUncheckedCreateWithoutProductInput
        >
      | TransactionCreateWithoutProductInput[]
      | TransactionUncheckedCreateWithoutProductInput[];
    connectOrCreate?:
  ...
  export type ProductCreateNestedOneWithoutTransactionsInput = {
    create?: XOR<
      ProductCreateWithoutTransactionsInput,
      ProductUncheckedCreateWithoutTransactionsInput
    >;
  ...
  export type ProductUpdateOneRequiredWithoutTransactionsNestedInput = {
    ...
    update?: XOR<
      XOR<
        ProductUpdateToOneWithWhereWithoutTransactionsInput,
        ProductUpdateWithoutTransactionsInput
      >,
      ProductUncheckedUpdateWithoutTransactionsInput
    >;
  };
  ...
  export type TransactionUpsertWithWhereUniqueWithoutProductInput = {
    ...
    update: XOR<
      ...
      TransactionUncheckedUpdateWithoutProductInput
    >;
    create: XOR<
      TransactionCreateWithoutProductInput,
      TransactionUncheckedCreateWithoutProductInput
  ...
  export type TransactionUpdateManyWithWhereWithoutProductInput = {
    ...
    data: XOR<
      TransactionUpdateManyMutationInput,
      TransactionUncheckedUpdateManyWithoutProductInput
    >;
  };
